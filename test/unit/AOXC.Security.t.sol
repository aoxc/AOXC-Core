...
contract AOXCSecurityTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory initData = abi.encodeWithSelector(AOXCSecurityRegistry.initializeApex.selector, admin, aiSentinel);
        ...
        returns (bytes memory)
    {
        ...
        bytes32 rawHash =
            keccak256(abi.encode(actionHash, risk, target, _getRegistryNonce(), address(registry), block.chainid));
