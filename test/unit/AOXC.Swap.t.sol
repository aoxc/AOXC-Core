...
contract AOXCSwapMasterclass is Test {
    ...
    bytes32 internal constant SWAP_STORAGE_SLOT = 0x487f909192518e932e49c95d97f9c733f5244510065090176d6c703126780a00;
    ...
    function setUp() public {
        ...
        vm.mockCall(
            sentinel, abi.encodeWithSignature("isAllowed(address,address)", trader, address(treasury)), abi.encode(true)
        );
